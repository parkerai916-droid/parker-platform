...
CATALOGUE: tuple[FormatDefinition, ...] = (
    ...
    FormatDefinition((".rtf",), ("application/rtf", "text/rtf"), "document", "bounded RTF reader", "yes", "text and reliable control structure", False, "not applicable", "single document", True, "native"),
