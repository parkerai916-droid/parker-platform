...
class ParkerRuntimeStartupAndShutdownTest {
    ...
    private fun config(
        ...
        correctedPreparationStorageRootPath: String? = null,
        ...
        correctedPreparationStorageRootPath = correctedPreparationStorageRootPath,
        ...
        try {
            ...
            fun runtime(build: String) = ParkerRuntime(
                config(
                    ...
                    correctedPreparationStorageRootPath = testDirectory(root, "corrected-preparations").toString(),
