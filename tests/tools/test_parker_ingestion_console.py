...
class ConsoleBoundaryTest(unittest.TestCase):
    def test_console_renders_direct_parker_analysis_link_in_new_tab(self):
        page = (ROOT / "tools" / "parker_ingestion_console" / "index.html").read_text()
        link = '<a class="nav-link" href="https://parker.home.arpa/#analysis" target="_blank" rel="noopener noreferrer">Open Parker Analysis ↗</a>'
