...
fun evidenceStatusLabel(status: OwnerEvidenceFileStatus): String = when (status) {
    ...
    OwnerEvidenceFileStatus.REGISTERED -> "Registered"
    ...
    OwnerEvidenceFileStatus.CAPABILITY_UNAVAILABLE -> "Capability unavailable"
    OwnerEvidenceFileStatus.REVIEW_REQUIRED -> "Review required"
    OwnerEvidenceFileStatus.ANALYSIS_READY -> "Analysis ready"
