...
internal fun buildOwnerHttpAdapter(runtime: ParkerRuntime, config: ParkerRuntimeConfig): OwnerUiEvidenceRuntimeAdapter =
    OwnerUiEvidenceRuntimeAdapter(
        ...
        authorizeExternalTranscriptionWithPinAsOwner = runtime::authorizeExternalTranscriptionAsOwnerWithPin,
...
fun main(args: Array<String>) = runBlocking {
    ...
    val ownerHttpServer = if (config.ownerHttpPort != null) {
        ...
        OwnerEvidenceHttpServer(
            ...
            ownerPinEnabled = runtime::ownerPinAuthorizationEnabled,
            ownerPinAvailable = runtime::ownerPinAuthorizationAvailable,
            authorizeExternalTranscriptionWithPin = runtime::authorizeExternalTranscriptionAsOwnerWithPin,
